...
pub fn fill_missing_rank_with_cross_sectional_median(ranked: &mut Array2<f32>, active: &Array2<f32>) {
...
pub fn rank_and_fill_missing_cross_sectional_median(variant_values: &Array2<f32>) -> Array2<f32> {
