...
/// 第四轮 8 列（forward_sec=180 跨股诊断 000001/600519/300750 ×4套 ≥10/12 组合
///   seg 100%NaN 的死列：r20_det/r20_abs/br/ct_da 的 ac1 + ct_b/ct_d 的 skew +
///   ct_s 的 skew&ac1。这些 aggregate5 高阶统计在低占比短段内有效点不足，永远算不出）。
pub const DELETE_COLS: [usize; 84] = [
    2, 10, 11, 12, 13, 14, 15, 16, 24, 28, 33, 35, 41, 45, 46, 48, 49, 51, 53, 55, 56, 57, 58, 61,
    64, 65, 66, 67, 68, 69, 70, 72, 78, 79, 81, 85, 86, 89, 90, 91, 92, 94, 95, 96, 99, 100, 101,
    102, 103, 104, 105, 106, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121,
    122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 134, 135, 136, 137, 139, 141, 143,
];

/// 输出列数 = NCOLS - DELETE_COLS.len() = 147 - 84 = 63。
pub const NCOLS_OUT: usize = 63;
