...
fn rust_pyfunc(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    let _ = m.add_function(wrap_pyfunction!(
        tail_rank_fill_roll::tail_v5_rank_fill_roll_block_f32,
        m
    )?);
    let _ = m.add_function(wrap_pyfunction!(
    ...
    let _ = m.add_class::<factor_neutralize_std::NeutralizeStdSharedHandle>()?;
    let _ = m.add_function(wrap_pyfunction!(
        factor_neutralize_std::neutralize_std_precompute_py,
        m
    )?);
    let _ = m.add_function(wrap_pyfunction!(
    ...
    let _ = m.add_function(wrap_pyfunction!(
        limit_order_lifecycle_v2::reconstruct_limit_order_lifecycle_v2,
        m
    )?);
    let _ = m.add_function(wrap_pyfunction!(
    ...
    let _ = m.add_function(wrap_pyfunction!(
        microstructure_pattern_features::calculate_microstructure_pattern_features,
        m
    )?)?;
    ...
    let _ = m.add_function(wrap_pyfunction!(
        hot_stock_pool_metrics::py_hot_stock_pool_z_stats,
        m
    )?)?;
    let _ = m.add_function(wrap_pyfunction!(
    ...
    let _ = m.add_function(wrap_pyfunction!(
        long_order_cross_section_metrics::py_long_order_names,
        m
    )?)?;
    let _ = m.add_function(wrap_pyfunction!(
